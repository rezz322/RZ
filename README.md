...
* 📅 **Миттєвий розклад по днях**: Зручна навігація днями тижня за допомогою інлайн-кнопок (`⬅️ День назад`, `День вперед ➡️`, `Пн`–`Пт`/`Сб`, `📅 Сьогодні`). Повна автоматична підтримка робочих субот згідно з наказами ректора про перенесення занять.
* ⚡ **Блискавична швидкість**: Розклад зберігається в in-memory кеші (швидкість рендеру ~0.09 мс).
* 🔔 **Нагадування за 10 хвилин**: Автоматичне надсилання сповіщень усім підписникам за 10 хвилин до початку пари з прямими посиланнями на Zoom/Google Meet (включно з робочими суботами).
